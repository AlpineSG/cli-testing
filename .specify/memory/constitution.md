...
### II. Type Annotations
Type hints are required on all function signatures and public interfaces. Use Pydantic models or dataclasses for structured data. Pyright type checking runs in CI — type errors block merges.
